<div class="container-fluid gedf-wrapper">
    <div class="row">
        <div class="col-md-3 gedf-main">
            ...
            @if(\Carbon\Carbon::parse($eventS->start_date)->format('d/m/Y')>=\Carbon\Carbon::now()->format('d/m/Y') && \Carbon\Carbon::parse($eventS->start_date)->diffInDays(\Carbon\Carbon::now())<7)
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <br>
                                    Resim Önizlemesi:
                                    <img src="{{ $photo->temporaryUrl() }}" class="rounded-xl img-fluid mx-auto myImg" id="myImg">
                                    @endif
                                </div>
                            </div>
                        </div>
            ...
            @else
                ...
                <div class="shadow-md rounded-xl sp-bg">
                            ...
                            <div class="d-flex justify-content-between align-self-center">
                                <a href="{{route('profiles.show', $post->user->username)}}">
                                    <button
                                        ...
                                        <img class="h-12 w-12 rounded-circle object-cover myImg"
                                            src="{{$post->user->profile_photo_url}}" alt="{{$post->user->username}}" id="myImg">&nbsp;
                                        <label class="pt-1">
                    ...
                    <div class="card-body">
                        ...
                        <img class="rounded-xl img-fluid mx-auto shadow-sm myImg" src="{{ asset('storage/' . $post->post_photo_path) }}" alt="" id="myImg"><br>
                        <!-- The Modal -->
                    ...
                    @if($post->event_photo_path)
                        <img class="rounded-xl img-fluid mx-auto shadow-sm myImg" src="{{ asset('storage/' . $post->event_photo_path) }}" alt="" id="myImg">
                        <!-- The Modal -->
                        <div id="myModal" class="modal">
                                        <span class="close">&times;</span>
                                        <img class="modal-content" id="img01">
...
<script>
    ...
    var img = document.getElementsByClassName("rounded-xl img-fluid mx-auto shadow-sm myImg");
